  ...
  return (
    <div className="bg-white rounded-lg p-6 mt-4 flex gap-8 flex-col">
        ...
        <div className="flex justify-between gap-2 items-center">
            ...
            <div className="h-1 w-[6rem] md:w-[35rem] rounded-lg bg-gradient-to-r from-red-500 via-yellow-500 to-green-500"></div>
        ...
        <div>
            ...
            <div className="flex justify-between flex-col md:flex-row whitespace-nowrap gap-4 md:gap-0">
                <div className="flex flex-col gap-4"> 
                    <div className="flex justify-between gap-[5rem] text-[.65rem] md:text-[.75rem] border-b-2 pb-3 pr-2 md:gap-[12rem]">
                        <span className="text-[#768396]">Bitcoin Price</span>
                        <span className="font-semibold">${data.bitcoin.usd.toLocaleString("en-US")}</span>
                    </div>
                    <div className="flex justify-between gap-[3rem] text-[.65rem] border-b-2 pb-3 pr-2">
                        <span className="text-[#768396]">24h Low / 24h High</span>
                        <span className="font-semibold">$16,382.07 / $16,874.12</span>
                    </div>
                    <div className="flex justify-between gap-[3rem] text-[.65rem] md:text-[.75rem] border-b-2 pb-3 pr-2">
                        <span className="text-[#768396]">7d Low / 7d High</span>
                        <span className="font-semibold">$16,382.07 / $16,874.12</span>
                    </div>
                    <div className="flex justify-between gap-[5rem] text-[.65rem] md:text-[.75rem] border-b-2 pb-3 pr-2">
                ...
                <div className="flex flex-col gap-4"> 
                    <div className="flex justify-between gap-[5rem] text-[.65rem] md:text-[.75rem] border-b-2 pb-3 pr-2 md:gap-[10rem]">
                    ...
                    <div className="flex justify-between gap-[5rem] text-[.65rem] md:text-[.75rem] border-b-2 pr-2 pb-1 pt-2 mt-[-1rem] items-center">
                    ...
                    <div className="flex justify-between gap-[5rem] text-[.65rem] md:text-[.75rem] border-b-2 mt-[-1rem] pb-1 pt-2 pr-2 items-center">
